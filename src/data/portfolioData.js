...
export const capabilities = [
  ...
  },
  {
    ...
    category: 'Marketing',
    headline: 'Data-Driven Growth Strategies and High-Converting Campaign Architectures.',
    description: 'We Design and Execute Performance Marketing Campaigns, Search Engine Optimization, Lead Acquisition Funnels, and Customer Analytics Pipelines to Accelerate Business Revenue.',
    deliverables: ['Performance Ad Campaigns', 'Search Engine Optimization (SEO)', 'Conversion Rate Optimization (CRO)', 'Lead Acquisition Funnels', 'Marketing Data Analytics']
  },
  {
    id: 'content-creation',
    number: '08',
    ...
    category: 'Media',
    headline: 'Compelling Visual Storytelling and Multi-Channel Brand Engagement.',
    description: 'We Produce High-Quality Digital Media, Strategic Copywriting, Social Media Campaigns, and Video Assets That Build Brand Equity and Engage Target Audiences.',
    deliverables: ['Brand Visual & Graphic Design', 'Social Media Strategy & Management', 'Copywriting & Editorial Content', 'Short-Form Video Production', 'Audience Growth Campaigns']
  },
  {
    id: 'ui-ux',
    number: '09',
...
export const technologies = {
  ...
  Marketing: [
    { name: 'Google Ads & Meta Ads', desc: 'Targeted High-Intent Lead Acquisition' },
    { name: 'Search Engine Optimization', desc: 'Organic Search Visibility and Technical SEO' },
    { name: 'Zoho Marketing Automation', desc: 'Automated Email & SMS Behavioral Journeys' },
    { name: 'Social Media Management', desc: 'Multi-Channel Brand Content Strategy' }
  ],
  Integrations: [
